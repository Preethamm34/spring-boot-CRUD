...
function checkUserNameAndEmail() {
  ...
  alert(emailadd);
	...
	$.ajax({
		dataType : 'json',
		url : "${pageContext.request.contextPath}/lgn/checkUserName",
		type : 'GET',
		data : {								
			'emailadd' : emailadd,
			'userName' : userName
	...
	success : function(response) {	
		if(response.counts==1){
			alert("userName "  + userName +  " Already Exists, Try Different !");
      alert("emailadd "  + emailadd +  " Already Exists, Try Different !");
			$("#userName").val('');
      $("#emailadd").val('');
			$("#userName").focus();
      $("#emailadd").focus();
          ...
          <div class="row">
            <div class="col-sm-6 text-black">
              ...
              <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                ...
                <form id="signInForm" style="width: 23rem;" action="${pageContext.request.contextPath}/lgn/editUser/${userId}" method="post">

                  <h3 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;"> Update </h3>
              
                  <input type="text" name="userId" id="userId" value="${user.userId}"/>
                  ${user}
                  <div data-mdb-input-init class="form-outline mb-4">
                      <input type="text" id="userName" name="userName"  class="form-control form-control-lg" value="${user.userName}" />${user.userName}
                      <label class="form-label" for="userName">User Name<span style="color: red;">*</span></label>
                  </div>  
                  <!-- onchange="checkUserNameAndEmail()" -->
              
                  <div data-mdb-input-init class="form-outline mb-4">
                      <input type="tel" id="phoneNumber" name="phoneNumber" class="form-control form-control-lg" pattern="[0-9]{10}" value="${user.phoneNumber}" />
                      <label class="form-label" for="phoneNumber">Phone Number<span style="color: red;">*</span></label>
                  </div>
              
                  <div data-mdb-input-init class="form-outline mb-4">
                      <input type="email" id="emailadd" name="emailadd" class="form-control form-control-lg" value="${user.emailadd}"/>
                  ...
                  <div data-mdb-input-init class="form-outline mb-4 password-container">
                      <div style="position: relative;">
                          <input type="password" id="password" name="password" class="form-control form-control-lg" value="${user.password}" required readonly/>
                  ...
                  <div class="pt-1 mb-4">
                      <button data-mdb-button-init data-mdb-ripple-init id="submitButton" class="btn btn-info btn-lg btn-block" type="submit">Update</button>
                  </div>
